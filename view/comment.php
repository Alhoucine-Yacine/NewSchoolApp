...
include("header.php");
echo'<br><br>
<br> <h2 align=left style="margin-left:30px">  Commentaires pour '.$_GET['ecole'].' : </h2>
<div>';
echo $controller->getComments($_GET['id']).'</div>
<br>
<h2 align=left style="margin-left:30px"> Votre commentaire </h2>
<br>
<form method="post">
<textarea name="txt" style="width:90%;height:200px;padding:10px;font-size:24px"></textarea><br><br>
<textarea name="idd" hidden>'.$_GET['id'].'</textarea>
<Button name="btn" id="cmnt"> Commenter </Button></form>';
 ?>
